...
-- Crear Icono en la esquina (visible)
...
ToggleButton.ImageTransparency = 0 -- aseguramos que se vea
ToggleButton.ZIndex = 10

-- Ocultar panel principal al inicio
local MainWindowVisible = false

-- Cargar script principal al presionar el botón
ToggleButton.MouseButton1Click:Connect(function()
    if not MainWindowVisible then
